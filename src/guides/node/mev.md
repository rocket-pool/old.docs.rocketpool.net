...
::::: tab Native Mode
To install and configure MEV-Boost, refer to [Rémy Roy's instructions](https://github.com/remyroy/ethstaker/blob/main/prepare-for-the-merge.md#installing-mev-boost). They walk you through creating a user account for the service, downloading and start the MEV-Boost service, and configuring your consensus clients to use MEV-Boost. You can also refer to [Flashbot's documentation](https://github.com/flashbots/mev-boost) for more information. 
::: danger WARNING
