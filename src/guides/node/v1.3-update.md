# [BETA] Upgrading to Smartnode v1.3.x
...
In this guide, we'll walk you through the process of migrating from an older version of the Smartnode to v1.3.x and beyond.
...
- For **Docker Mode**, please visit [the new Docker configuration guide](./beta-docker.md#configuring-the-smartnode-stack-via-the-wizard).

- **Hybrid Mode** users: Hybrid Mode is now a **first-class feature** of the Smartnode and configuring it is *much* easier than it used to be. Please visit [the new Docker configuration guide](./beta-docker.md#configuring-the-smartnode-stack-via-the-wizard) and follow it. When you are prompted to choose an Execution client mode and Consensus client mode, choose **Externally Managed** for them accordingly.

- For **Native Mode**, please visit [the new Native configuration guide](./beta-native.md#configuring-the-smartnode-stack-via-the-wizard).
:::
